...
const Footer = () => {
  ...
  return (
<footer className="border-t border-[#47c5fb]/30 backdrop-blur-md">
          ...
          >
            {socialLinks.map((link, index) => (
              <motion.a
                ...
                className="text-gray-400 hover:text-[#47c5fb] transition-colors duration-300 hover:scale-110 transform"
                target="_blank"
